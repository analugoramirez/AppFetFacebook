<template>
    <v-navigation-drawer width="300px" color="grey lighten-5" floating clipped app permanent>
        <v-container>
            <v-card dark color="green darken-1" rounded outlined>
                 <v-list-item class="pt-5">
                    <v-list-item-avatar>
                        <img src="../assets/avatars/16.jpeg" alt="John">
                    </v-list-item-avatar>
                    <v-list-item-content class="mt-2">
                        <v-list-item-title class="questrial subtitle">Maria</v-list-item-title>
                        <v-list-item-subtitle class="questrial caption">Est Ing de Software - FET</v-list-item-subtitle>
                    </v-list-item-content>
                </v-list-item>
                <v-container>
                    ...
                    <v-layout wrap justify-space-around class="py-2">
                        ...
                        <v-flex xs6 style="text-align: center">
                            <div class="questrial caption font-weight-bold"> 1265 Amigos</div>
                        </v-flex>
                    </v-layout>
            ...
            <v-card class="mt-3" rounded outlined>
                <v-card-title class="mb-2">
                    <div class="questrial body-2 font-weight-bold">Noticias</div>
                    <v-spacer></v-spacer>
                ...
                <v-list-item dense>   
                    ...
                    <v-list-item-content>
                        <div class="questrial caption text--grey">La FET participa en la hackaton 2019<div class="indigo--text font-weight-bold"> Ver mas..</div></div>
                    </v-list-item-content>
                </v-list-item>
                <v-list-item dense>   
                    <v-list-item-icon>
                    ...
                    <v-list-item-content>
                        <div class="questrial caption text--grey">Todas las actividades de clases quedaron suspendidas por meteorito</div>
                    </v-list-item-content>
                </v-list-item>
            </v-card>
            <v-card class="mt-2" rounded outlined>
               <v-card-title class="mb-2">
                    <div class="questrial body-2 font-weight-bold">Galeria de Fotos</div>
                    <div class="questrial caption font-weight-bold ml-4 grey--text text--darken-1">132 Fotos</div>
                    <v-spacer></v-spacer>
                    <v-icon @click="" small>more_horiz</v-icon>
                </v-card-title>
...
export default {
    data(){
        return {
            item: 1,
            items: [
                {text: 'Noticias', icon: 'assignment'},
                {text: 'Chat', icon: 'fa-comments'},
                {text: 'Configuración', icon: 'fa-briefcase'},
                {text: 'Eventos', icon: 'event'},
                {text: 'Guardados', icon: 'bookmark'},
                {text: 'Recomendaciones', icon: 'store'},
                {text: 'Juegos', icon: 'fa-gamepad'},
